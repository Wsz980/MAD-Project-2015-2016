...
public class Tests {
 ...
 ;
	...
	private String stateSelect, capitalSelect1, capitalSelect2,
	capitalSelect3, capitalSelect4, answ;
	
	public Tests(int mindraw) {
	//Test();
	select(mindraw);
	}
...
//		int in2 = input2.nextInt();
	...
	public void select(int mindraw) {
		In inState = new In("stemfirst.txt");
		...
		In inCapi = new In("stemsecond.txt");
		
		String[] capitals = new String[25];
		int icp = 0;
